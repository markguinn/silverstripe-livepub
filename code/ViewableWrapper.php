...
class ViewableWrapper extends ViewableData
{
     ...
     * @return ViewableWrapper (chainable)
     */
    public function setLiveVars($lv)
    {
        $this->liveVars = $lv;
        return $this;
    }
     ...
     * @return ViewableWrapper (chainable)
     */
    public function setUnescapedVars(array $vars)
    {
     ...
     * @return array
     */
    public function getUnescapedVars()
    {
